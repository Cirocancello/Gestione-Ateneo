...
public class University {
	...
	private String name; //nome dell' universit�
	private String rector; // rettore dell' universit�
	...
	/**
	 * definisce informazioni del Rettore dell' universit�
	 * 
	...
	/**
	 *  inserisce uno studente in una universit�
	 *  
	 * @param first : nome dello studente
	 * @param last  : cognome dello studente
	 * @return il metodo restituisce il numero di matricola che � stato assegnato allo studente
	 */
...
// in alternativa si pu� usare questo metodo che fa esattamente la stessa operazione
